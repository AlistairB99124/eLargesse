...
namespace eLargesse
{
    public class EmailService : IIdentityMessageService
    {
        public async Task SendAsync(IdentityMessage message)
        {
            ...
            myMessage.From = new MailAddress("alistair.bowendavies@gmail.com", "eLargesse Auto Response");
            ...
            var credentials = new NetworkCredential("alistair.bowendavies@gmail.com", "iPodu2_2012");
