                    ...
                    <div class="woocommerce-billing-fields">
                        ...
                        <p id="billing_country_field" class="form-row form-row-wide address-field update_totals_on_change validate-required woocommerce-validated">
                            ...
                            <asp:SqlDataSource ID="CountryDataSource" runat="server" 
                                ConnectionString="Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\eLargesse.mdf;Integrated Security=True;MultipleActiveResultSets=True;Application Name=EntityFramework" 
                        ...
                        <p id="billing_first_name_field" class="form-row form-row-first validate-required">
                            <asp:Label CssClass="" runat="server" AssociatedControlID="billing_first_name">First Name<abbr title="required" class="required">*</abbr>
                            </asp:Label>
                            <asp:TextBox runat="server" placeholder="First Name..." ID="billing_first_name" />
                            <asp:RequiredFieldValidator runat="server" ControlToValidate="billing_first_name"
                                        CssClass="text-danger" ErrorMessage="The First Name is required." />
                        </p>

                        <p id="billing_last_name_field" class="form-row form-row-last validate-required">
                            <asp:Label runat="server" CssClass="" AssociatedControlID="billing_last_name">Last Name<abbr title="required" class="required">*</abbr>
                            </asp:Label>
                            <asp:TextBox runat="server" placeholder="" ID="billing_last_name" CssClass="input-text" />
                             <asp:RequiredFieldValidator runat="server" ControlToValidate="billing_last_name"
                        ...
                        <p id="billing_address_1_field" class="form-row form-row-wide address-field validate-required">
                            ...
                            <asp:RequiredFieldValidator runat="server" ControlToValidate="billing_address_1"
                                        CssClass="text-danger" ErrorMessage="Address Line One is required." />
                        </p>
                        ...
                        <p id="billing_city_field" class="form-row form-row-wide address-field validate-required" data-o_class="form-row form-row-wide address-field validate-required">
                            ...
                            <asp:TextBox runat="server" placeholder="Town / City" ID="billing_city" CssClass="input-text" />
                              <asp:RequiredFieldValidator runat="server" ControlToValidate="billing_city"
                        ...
                        <p id="billing_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">
                            ...
                            <asp:RequiredFieldValidator runat="server" ControlToValidate="billing_state"
                        ...
                        <p id="billing_postcode_field" class="form-row form-row-last address-field validate-required validate-postcode" data-o_class="form-row form-row-last address-field validate-required validate-postcode">
                            ...
                            <asp:RequiredFieldValidator runat="server" ControlToValidate="billing_postcode"
                                        CssClass="text-danger" ErrorMessage="Postal Code is required." />
                        </p>
                        <div class="clear"></div>
                        <p id="billing_email_field" class="form-row form-row-first validate-required validate-email">
                            <asp:Label runat="server" CssClass="" AssociatedControlID="billing_email">Email Address<abbr title="required" class="required">*</abbr>
                            </asp:Label>
                            <asp:TextBox runat="server" placeholder="" ID="billing_email" CssClass="input-text" TextMode="Email" />
                            <asp:RequiredFieldValidator runat="server" ControlToValidate="billing_email"
                                        CssClass="text-danger" ErrorMessage="Email is required." />
                        </p>
                        <p id="billing_phone_field" class="form-row form-row-last validate-required validate-phone">
                            <asp:Label runat="server" CssClass="" AssociatedControlID="billing_phone">Phone<abbr title="required" class="required">*</abbr>
                            </asp:Label>
                            <asp:TextBox runat="server" placeholder="" ID="billing_phone" CssClass="input-text" />
                        </p>
                        <div class="col-md-offset-2">
                            <p>Update billing info:</p>
                            <asp:Button runat="server" Text="Update" ID="updateProfile" CssClass="btn btn-primary" OnClick="updateProfile_Click" />
                            <p><asp:Label runat="server" ID="UpdateResultLabel" /></p>
                        </div>
                        <div class="clear"></div>
                    </div>
                </div>
                    ...
                    <div class="woocommerce-shipping-fields">
                        ...
                        <div class="shipping_address" style="display: block;">
                            ...
                            <p id="shipping_address_1_field" class="form-row form-row-wide address-field validate-required">
                                ...
                                <asp:TextBox runat="server" ID="shipping_address_1" CssClass="input-text " />
                            </p>
            ...
            <div id="order_review" style="position: relative;">
                ...
                <div id="payment">
                    ...
                    <div class="form-row place-order">
                        ...
                        <asp:Button runat="server" ID="place_order" Text="Continue to Payment" CssClass="btn btn-primary" OnClick="place_order_Click" />
                    </div>
