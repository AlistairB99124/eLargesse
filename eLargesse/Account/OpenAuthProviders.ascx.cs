...
namespace eLargesse.Account
{
    public partial class OpenAuthProviders : System.Web.UI.UserControl
    {
        ...
        public string GetCssClass(string Item)
        {
            string cssClass="";
            switch (Item)
            {
                case "Facebook":
                    ...
                    break;
                case "Google":
                    cssClass = "btn btn-block btn-social btn-google";
                    break;
                default:
                    cssClass = "btn btn-block btn-social btn-default";
                    break;
            }
            return cssClass;
        }
        public string GetCssProviderName(string Item)
        {
            string cssClass = "";
            switch (Item)
            {
