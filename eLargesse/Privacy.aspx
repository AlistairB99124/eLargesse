<%@ Page Title="Privacy Policy" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Privacy.aspx.cs" Inherits="eLargesse.Privacy" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container">
        ...
        <div id='ppHeader'>http://localhost:58543/ Privacy Policy</div>
        <div id='ppBody'>
            ...
            <div class='ppConsistencies'>
                ...
                <div class='col-2'>
                    <div class="quick-links2 gen-text-center">Our Contact Information<br>
                    </div>
                </div>
            </div>
            <div style='clear: both; height: 10px;'></div>
            ...
            <div class='innerText'>We do not use Malware Scanning.<br>
                <br>
            </div>
            ...
            <div class='innerText'>Eductional Purposes</div>
            <span id='coUs'></span>
            <br>
        ...
        <div class='innerText'>http://localhost:58543/</div>
        <div class='innerText'>1 Airlie Lane</div>
        Cape Town, Western Cape 7806
        <div class='innerText'>South Africa</div>
        <div class='innerText'>alistair.bowendavies@gmail.com</div>
        <div class='innerText'>+27793642185</div>
        <div class='innerText'>
            <br>
            Last Edited on 2016-05-08</div>
    </div>
    </div>
</asp:Content>
